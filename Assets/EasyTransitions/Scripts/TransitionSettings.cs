...
namespace EasyTransition
{
    ...
    public class TransitionSettings : ScriptableObject
    {
        ...
        [Space(10)] [Tooltip("Sets the size of the transition on the x axis to -1.")]
        public bool flipX;

        [Tooltip("Sets the size of the transition on the y axis to -1.")]
        public bool flipY;

        [Space(10)] [Tooltip("Time between transition start and scene load in seconds.")]
        public float transitionTime = 1.5f;

        [Tooltip("Time after scene load within the transition gets destroyed.")]
        public float destroyTime = 3f;

        [Header("Transition Prefabs")] [Space(10)]
